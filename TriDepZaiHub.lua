...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=blue>Tết Vui vẻ<Color=/>"):Display()
    wait(.5)
    require(game.ReplicatedStorage.Notification).new("<Color=blue >Cày Thuê Thì ib Zalo 0797791509<Color=/>"):Display()
    wait(.14)
    require(game.ReplicatedStorage.Notification).new("<Color=Orange>FF9933<Color=/>"):Display()
    wait(.24)
    require(game.ReplicatedStorage.Notification).new("<Color=Orange>Năm mới vui vẻ và hạnh phúc<Color=/>"):Display()
    wait(.29)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Tiktok : vantridz1509 <Color=/>"):Display()
    wait(.36)
end)

local Window = Fluent:CreateWindow({
    Title = "TriDepZai Hub",
    SubTitle = "by TriDeoZai",
    TabWidth = 160,
...
ImageButton.Image = "rbxassetid://16243047096"
